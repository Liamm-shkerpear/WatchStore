...
public class VNPayService extends ConfigVNPay {
    public static String getRequest(String amount, String bankCode, String language, String currency, HttpServletRequest req) throws UnsupportedEncodingException {
