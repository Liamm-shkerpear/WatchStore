...
//        request.getRequestDispatcher("forgotPassword.jsp").forward(request, response);
        try{
            ...
            String get_email = session.getAttribute("emailForgot").toString();
            User user = new User();
            ...
            if (sendEmail.sendEmail(user, otp)) {
                session.setAttribute("forgotPasswordOTP", otp);
                session.setAttribute("emailForgot", user.getEmail());
                response.sendRedirect("/forgot-password-verify");
            } else {
